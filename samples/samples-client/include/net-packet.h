...
{
    return parse_req( pc_buffer, i_size, i_offset, st_packet.str_buff );
...
{
    //UINT32 ui_len = strlen(st_packet.ac_buff);
    return pack_resp( vc_buffer, st_packet.str_buff);
